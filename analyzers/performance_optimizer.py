#!/usr/bin/env python3
"""
Performance Optimizer for EndPointHawk Scanner
...
class IntelligentCache:
    ...
    def __init__(self, cache_dir: str = "./cache"):
        ...
        self.db_path = self.cache_dir / "endpointhawk_cache.db"
...
class PerformanceOptimizer:
    ...
    def __init__(self, config: ScanConfig):
        ...
        if PSUTIL_AVAILABLE:
            ...
            self.process = None
            # Silently handle psutil unavailability - no need to warn users
    ...
    def analyze_repository(self, repo_path: str) -> RepositoryMetrics:
        ...
        relevant_extensions = {'.js', '.ts', '.py', '.go', '.java', '.jsx', '.tsx', '.proto', '.dart'}
        ...
        if metrics.relevant_files < 500:  # Lowered threshold for better performance
            ...
            metrics.estimated_scan_time = metrics.relevant_files * 0.003  # 3ms per file (optimized)
            ...
            metrics.estimated_scan_time = metrics.relevant_files * 0.0025  # 2.5ms per file (optimized)
        else:
            ...
            metrics.estimated_scan_time = metrics.relevant_files * 0.002   # 2ms per file (optimized)
    ...
    def optimize_file_discovery(self, repo_path: str, include_patterns: List[str], 
        ...
        for root, dirs, filenames in os.walk(repo_path):
            ...
            for filename in filenames:
                ...
                if file_path.suffix.lower() in {'.js', '.ts', '.py', '.go', '.java', '.jsx', '.tsx', '.proto', '.dart'}:
