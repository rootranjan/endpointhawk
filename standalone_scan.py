#!/usr/bin/env python3
"""
Standalone EndPointHawk scan script that can be called from Flask subprocess
...
async def run_scan(repo_path: str):
    """Run an EndPointHawk scan using the exact CLI pattern"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Standalone EndPointHawk scanner')
