#!/usr/bin/env python3
"""
Data models for EndPointHawk API scanner
...
class RouteInfo(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            'path': self.path,
            'method': self.method.value if isinstance(self.method, HTTPMethod) else self.method, 
...
class ScanConfig(BaseModel):
    ...
    repo_path: str
    include_patterns: List[str] = Field(default_factory=lambda: ["**/*.ts", "**/*.js", "**/*.py", "**/*.go", "**/*.java", "**/*.dart"])
    ...
    # Additional fields used in main endpointhawk.py
