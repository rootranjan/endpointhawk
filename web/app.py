#!/usr/bin/env python3
"""
Web interface for EndPointHawk Attack Surface Discovery Tool
...
from endpointhawk_core.endpointhawk import AttackSurfaceScanner, auto_detect_frameworks
...
def export_results(format):
    ...
    if format == 'json':
        # Export as JSON
        output_path = f"reports/endpointhawk_report_{scan_id}.json"
        ...
        import csv
        output_path = f"reports/endpointhawk_report_{scan_id}.csv"
...
from endpointhawk import AttackSurfaceScanner, auto_detect_frameworks
